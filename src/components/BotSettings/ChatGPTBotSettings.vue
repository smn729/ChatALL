<template>
  ...
  <v-list-item>
    <v-list-item-title><span class="text-warning font-weight-bold">{{
            $t("settings.notice")
  ...
  <v-list-item>
    ...
    <v-checkbox v-model="autoRefresh" color="primary" hideDetails="auto" :label="$t('settings.enable')"></v-checkbox>
  </v-list-item>
</template>
...
import Bot from "src/bots/openai/ChatGPTBot";
