  ...
  <div id="app">
    <header>
      <div class="header-content">
        <img class="logo" src="src/assets/logo-banner.png" alt="ChatALL" />
        <div class="column-icons">
          <img src="src/assets/column-1.svg" @click="changeColumns(1)" :class="{ selected: columns === 1 }" />
          <img src="src/assets/column-2.svg" @click="changeColumns(2)" :class="{ selected: columns === 2 }" />
          <img src="src/assets/column-3.svg" @click="changeColumns(3)" :class="{ selected: columns === 3 }" />
        </div>
        <div>
...
// Components
import ChatMessages from "src/components/Messages/ChatMessages.vue";
